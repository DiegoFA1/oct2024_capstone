...
| **Similarity Measurement**   | Similarity is computed between items' titles (cosine similarity between vectors).   | Similarity is computed between items based on user interaction overlap.               |
